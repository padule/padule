            ...
            <div class="span2">
             ...
             <div class="span8">
                <div align="left" ><font size="5">
                    <br />
        <a href="/">登録を受け付けました。</a><br /><br />
この度はpaduleにご登録ありがとうござます。<br />
<br />
paduleは現在β版開発中ですので、サービス開始の際は改めてご連絡させていただきます。<br />
<br />
採用に関わる方々の工数を削減し、よりよい人材をご採用できるよう尽力して参ります。<br />
<br />
Padule team<br />
leader Akihiro Habuchi<br />
※ご不明な点などございましたら、FBまでご連絡ください。<br />
<a href="http://www.facebook.com/padule.me">http://www.facebook.com/padule.me</a><br />
</font>
</div>
</div>
            <div class="span2">
