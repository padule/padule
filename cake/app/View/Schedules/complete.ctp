        ...
        <div class="row">
            <div class="span2">
             ...
             <div class="span8">
                <font size="5">
                    <br />
        日程調整ページを作成しました。</font><br /><br />
        <font size="6" collor="black">
        <a href="http://padule.me/locks/add/<?php echo $groupId;?>" collor="black">http://padule.me/locks/add/<?php echo $groupId;?></a>
        </font>
        <br /><br />
        <a href="http://padule.me/schedules/" collor="black">スケジュール一覧へ戻る。</a>
</font>
</div>
            <div class="span2">
            </div>
